...
export type PersonBooexportk = Person & Book;//перетин
export type BookOrUndefined = Book | undefined;//об'єднання

// 07.04
export type BookRequiredField = Required<Book>;
